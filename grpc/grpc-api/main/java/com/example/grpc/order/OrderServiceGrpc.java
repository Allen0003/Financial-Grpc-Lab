...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.order.OrderRequest,
      com.example.grpc.order.OrderResponse> getGetOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOrder",
      requestType = com.example.grpc.order.OrderRequest.class,
      responseType = com.example.grpc.order.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.order.OrderRequest,
      com.example.grpc.order.OrderResponse> getGetOrderMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.order.OrderRequest, com.example.grpc.order.OrderResponse> getGetOrderMethod;
    if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
      synchronized (OrderServiceGrpc.class) {
        if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
          OrderServiceGrpc.getGetOrderMethod = getGetOrderMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.order.OrderRequest, com.example.grpc.order.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.order.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.order.OrderResponse.getDefaultInstance()))
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     * <pre>
     * 定義一個叫作 GetOrder 的 API，傳入 OrderRequest，回傳 OrderResponse
     * </pre>
     */
    public void getOrder(com.example.grpc.order.OrderRequest request,
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OrderServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.order.OrderResponse> getOrder(
        com.example.grpc.order.OrderRequest request) {
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.order.OrderProto.getDescriptor();
    }
